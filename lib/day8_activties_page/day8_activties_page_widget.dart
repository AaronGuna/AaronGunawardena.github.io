...
import 'day8_activties_page_model.dart';
export 'day8_activties_page_model.dart';

class Day8ActivtiesPageWidget extends StatefulWidget {
  const Day8ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day8ActivtiesPageWidgetState createState() =>
      _Day8ActivtiesPageWidgetState();
}

class _Day8ActivtiesPageWidgetState extends State<Day8ActivtiesPageWidget> {
  late Day8ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day8ActivtiesPageModel());
  }
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => TimePageWidget(),
                                    ),
                                  );
                                },
                                child: Container(
