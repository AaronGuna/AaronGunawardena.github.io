...
import '/final_obstacle_page/final_obstacle_page_widget.dart';
...
import 'day21_activties_page_model.dart';
export 'day21_activties_page_model.dart';

class Day21ActivtiesPageWidget extends StatefulWidget {
  const Day21ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day21ActivtiesPageWidgetState createState() =>
      _Day21ActivtiesPageWidgetState();
}

class _Day21ActivtiesPageWidgetState extends State<Day21ActivtiesPageWidget> {
  late Day21ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day21ActivtiesPageModel());
  }
