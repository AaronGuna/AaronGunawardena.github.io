...
import '/mud_page/mud_page_widget.dart';
import '/wife_lisa_page/wife_lisa_page_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'day13_activties_page_model.dart';
export 'day13_activties_page_model.dart';

class Day13ActivtiesPageWidget extends StatefulWidget {
  const Day13ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day13ActivtiesPageWidgetState createState() =>
      _Day13ActivtiesPageWidgetState();
}

class _Day13ActivtiesPageWidgetState extends State<Day13ActivtiesPageWidget> {
  late Day13ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day13ActivtiesPageModel());
  }
