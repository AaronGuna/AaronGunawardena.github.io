...
import 'day6_activties_page_model.dart';
export 'day6_activties_page_model.dart';

class Day6ActivtiesPageWidget extends StatefulWidget {
  const Day6ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day6ActivtiesPageWidgetState createState() =>
      _Day6ActivtiesPageWidgetState();
}

class _Day6ActivtiesPageWidgetState extends State<Day6ActivtiesPageWidget> {
  late Day6ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day6ActivtiesPageModel());
  }
