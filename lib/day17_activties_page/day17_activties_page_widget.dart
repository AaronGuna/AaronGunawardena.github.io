...
import '/mind_captain_page/mind_captain_page_widget.dart';
...
import 'day17_activties_page_model.dart';
export 'day17_activties_page_model.dart';

class Day17ActivtiesPageWidget extends StatefulWidget {
  const Day17ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day17ActivtiesPageWidgetState createState() =>
      _Day17ActivtiesPageWidgetState();
}

class _Day17ActivtiesPageWidgetState extends State<Day17ActivtiesPageWidget> {
  late Day17ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day17ActivtiesPageModel());
  }
