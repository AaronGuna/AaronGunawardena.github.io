...
import '/past_steal_page/past_steal_page_widget.dart';
...
import 'day11_activties_page_model.dart';
export 'day11_activties_page_model.dart';

class Day11ActivtiesPageWidget extends StatefulWidget {
  const Day11ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day11ActivtiesPageWidgetState createState() =>
      _Day11ActivtiesPageWidgetState();
}

class _Day11ActivtiesPageWidgetState extends State<Day11ActivtiesPageWidget> {
  late Day11ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day11ActivtiesPageModel());
  }
