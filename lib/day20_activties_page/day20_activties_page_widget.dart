...
import '/dayat_time_page/dayat_time_page_widget.dart';
import '/fantasy_page/fantasy_page_widget.dart';
import '/firedup_quotes_page/firedup_quotes_page_widget.dart';
...
import 'day20_activties_page_model.dart';
export 'day20_activties_page_model.dart';

class Day20ActivtiesPageWidget extends StatefulWidget {
  const Day20ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day20ActivtiesPageWidgetState createState() =>
      _Day20ActivtiesPageWidgetState();
}

class _Day20ActivtiesPageWidgetState extends State<Day20ActivtiesPageWidget> {
  late Day20ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day20ActivtiesPageModel());
  }
