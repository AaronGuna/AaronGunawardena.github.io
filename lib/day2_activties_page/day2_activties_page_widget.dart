...
import 'day2_activties_page_model.dart';
export 'day2_activties_page_model.dart';

class Day2ActivtiesPageWidget extends StatefulWidget {
  const Day2ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day2ActivtiesPageWidgetState createState() =>
      _Day2ActivtiesPageWidgetState();
}

class _Day2ActivtiesPageWidgetState extends State<Day2ActivtiesPageWidget> {
  late Day2ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day2ActivtiesPageModel());
  }
