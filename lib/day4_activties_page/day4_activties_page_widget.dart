...
import 'day4_activties_page_model.dart';
export 'day4_activties_page_model.dart';

class Day4ActivtiesPageWidget extends StatefulWidget {
  const Day4ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day4ActivtiesPageWidgetState createState() =>
      _Day4ActivtiesPageWidgetState();
}

class _Day4ActivtiesPageWidgetState extends State<Day4ActivtiesPageWidget> {
  late Day4ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day4ActivtiesPageModel());
  }
