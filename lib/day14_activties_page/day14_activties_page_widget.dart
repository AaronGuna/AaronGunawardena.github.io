...
import 'day14_activties_page_model.dart';
export 'day14_activties_page_model.dart';

class Day14ActivtiesPageWidget extends StatefulWidget {
  const Day14ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day14ActivtiesPageWidgetState createState() =>
      _Day14ActivtiesPageWidgetState();
}

class _Day14ActivtiesPageWidgetState extends State<Day14ActivtiesPageWidget> {
  late Day14ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day14ActivtiesPageModel());
  }
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => BoxerGFPageWidget(),
                                    ),
                                  );
                                },
                                child: Container(
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Text(
                                      'Read the boxer and his crazy GF',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
