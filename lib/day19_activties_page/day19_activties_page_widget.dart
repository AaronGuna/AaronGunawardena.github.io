...
import '/dreamer_page/dreamer_page_widget.dart';
...
import 'day19_activties_page_model.dart';
export 'day19_activties_page_model.dart';

class Day19ActivtiesPageWidget extends StatefulWidget {
  const Day19ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day19ActivtiesPageWidgetState createState() =>
      _Day19ActivtiesPageWidgetState();
}

class _Day19ActivtiesPageWidgetState extends State<Day19ActivtiesPageWidget> {
  late Day19ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day19ActivtiesPageModel());
  }
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DreamerPageWidget(),
                                    ),
                                  );
                                },
                                child: Container(
