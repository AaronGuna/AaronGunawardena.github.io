...
import 'day10_activties_page_model.dart';
export 'day10_activties_page_model.dart';

class Day10ActivtiesPageWidget extends StatefulWidget {
  const Day10ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day10ActivtiesPageWidgetState createState() =>
      _Day10ActivtiesPageWidgetState();
}

class _Day10ActivtiesPageWidgetState extends State<Day10ActivtiesPageWidget> {
  late Day10ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day10ActivtiesPageModel());
  }
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FriendsPageWidget(),
                                    ),
                                  );
                                },
                                child: Container(
