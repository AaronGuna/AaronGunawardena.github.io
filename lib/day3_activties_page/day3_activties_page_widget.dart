...
import 'day3_activties_page_model.dart';
export 'day3_activties_page_model.dart';

class Day3ActivtiesPageWidget extends StatefulWidget {
  const Day3ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day3ActivtiesPageWidgetState createState() =>
      _Day3ActivtiesPageWidgetState();
}

class _Day3ActivtiesPageWidgetState extends State<Day3ActivtiesPageWidget> {
  late Day3ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day3ActivtiesPageModel());
  }
