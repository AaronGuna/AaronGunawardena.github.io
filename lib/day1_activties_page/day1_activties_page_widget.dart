...
import 'day1_activties_page_model.dart';
export 'day1_activties_page_model.dart';

class Day1ActivtiesPageWidget extends StatefulWidget {
  const Day1ActivtiesPageWidget({Key? key}) : super(key: key);

  @override
  _Day1ActivtiesPageWidgetState createState() =>
      _Day1ActivtiesPageWidgetState();
}

class _Day1ActivtiesPageWidgetState extends State<Day1ActivtiesPageWidget> {
  late Day1ActivtiesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Day1ActivtiesPageModel());
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'Your first day on this journey!',
                      style:
